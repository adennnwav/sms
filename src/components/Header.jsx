...
const Header = (props) => {
	return (
		<div className="shadow-sm zindex-top">
			...
			<div className="px-3 py-2 border-bottom bg-body">
				<div className="container-fluid d-flex flex-wrap justify-content-center  ">
					<a href="/" className="d-flex align-items-center gap-3 mb-3 mb-md-0 me-md-auto text-body text-decoration-none custom-hover-zoom">
						...
						<span className="fs-3 fw-light">SMS</span>
					</a>
			...
			<div className="px-4 py-2 border-bottom bg-body-tertiary d-flex">
				<input className="form-control form-control-sm rounded-0 rounded-start sms-search" type="text" placeholder="Search..." aria-label=".form-control-sm example"/>
				<button type="submit" className="btn border border-start-0 rounded-0 rounded-end d-flex align-items-center px-2">
